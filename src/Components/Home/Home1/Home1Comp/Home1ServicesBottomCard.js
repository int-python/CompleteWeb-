...
`
  ...
  return (
    <Home1ServicesBottomCardHover to={props.Path} style={props.Style} className="home1ServicesBottomCard">
      ...
      <Home1ServicesBottomCardHeading className="home1ServicesBottomCardHeading">{props.Heading}</Home1ServicesBottomCardHeading>
      <Home1ServicesBottomCardDetail className="home1ServicesBottomCardDetail">{props.Detail}</Home1ServicesBottomCardDetail>
